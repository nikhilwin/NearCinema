    ...
    <div className="flex items-center justify-center min-height-screen py-16 px-4">
      <div className="glass-panel w-full max-w-md p-8 rounded-3xl shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-white text-glow mb-1">Create Account</h2>
          <p className="text-slate-400 text-sm">Join NearCinema to start booking tickets</p>
        </div>
        ...
        <p className="text-center text-slate-400 text-sm mt-8">
          ...
          <Link to="/login" className="text-brand-red hover:underline font-semibold">
            Login here
          </Link>
        </p>
      </div>
